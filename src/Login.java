...
public static void checkPassword() {
	if (EnteredPassword == tempPassword) {
		...
		case STUDENT: student.MainMenu(); 
		break;
		case TEACHER: Teacher.MainMenu();
			break;
		case ADMINISTRATOR: Administrator.MainMenu();
			break;
		}
	}else {
...
public static void LoginMain() {
	...
	System.out.println("Welcome to use SUSTech Reservation System.Please login.");
	while(Login.tries>0) {
